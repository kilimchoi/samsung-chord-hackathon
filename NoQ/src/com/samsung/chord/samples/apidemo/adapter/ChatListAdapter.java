...
public class ChatListAdapter extends BaseAdapter {
	...
	private ChatItem getItemByExchangeId(String exchangeId) {
		if (mChatItemList.isEmpty()) {
			Log.d(TAG, TAGClass + "getItemByExchangeId : List is Empty >"
					+ exchangeId);
			return null;
		}
	...
	public void addFileLog(boolean bMine, String nodeName, int progress,
			String exchangeId, String message) {
	...
	public void addFileCompleteLog(boolean bMine, String nodeName,
			String message, String exchangeId) {
		ChatItem item = getItemByExchangeId(exchangeId);
		if (null == item) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			mViewHolder.yourNodeName = (TextView) v
					.findViewById(R.id.yourNodeName);
			mViewHolder.chatMessage = (TextView) v
					.findViewById(R.id.chatMessage);
			mViewHolder.myNodeName = (TextView) v.findViewById(R.id.myNodeName);
			mViewHolder.fileLayout = (LinearLayout) v
					.findViewById(R.id.fileLayout);
			mViewHolder.progressLayout = (LinearLayout) v
					.findViewById(R.id.progressLayout);
			mViewHolder.progressBar = (ProgressBar) v
					.findViewById(R.id.progressBar);
			mViewHolder.fileCancelBtn = (Button) v
					.findViewById(R.id.fileCancelBtn);
			mViewHolder.chatLayout = (LinearLayout) v
		...
		if (chatItem.bMine) {
			...
			mViewHolder.chatLayout
					.setBackgroundResource(R.drawable.sentmessage);
		} else {
			...
			mViewHolder.chatLayout
					.setBackgroundResource(R.drawable.receivedmessage);
		}
		...
		if (null == fileItem) {
			...
			mViewHolder.fileCancelBtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					mCancelFileButtonListener
							.onCancelFileButtonClick(exchangeId);
				}
			});
		}
