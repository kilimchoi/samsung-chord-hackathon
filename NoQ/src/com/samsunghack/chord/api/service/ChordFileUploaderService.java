package com.samsunghack.chord.api.service;
...
public class ChordFileUploaderService extends Service {
    ...
    public class ChordFileUploaderServiceBinder extends Binder {
        public ChordFileUploaderService getService() {
            return ChordFileUploaderService.this;
        }
    }

    private final IBinder mBinder = new ChordFileUploaderServiceBinder();
