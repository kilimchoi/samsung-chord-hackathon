...
@SuppressLint("NewApi")
public class ChordListener extends Service {
    ...
    private static final String MESSAGE_TYPE_FILE_NOTIFICATION = "assets/file1.txt";
    ...
    public class ChordListenerBinder extends Binder {
        public ChordListener getService() {
            return ChordListener.this;
        }
    }

    private final IBinder mBinder = new ChordListenerBinder();
	...
	private void acqureWakeLock(){
		if(null == mWakeLock){
			...
			mWakeLock = powerMgr.newWakeLock(LayoutParams.FLAG_KEEP_SCREEN_ON, "ChordApiDemo Lock");
