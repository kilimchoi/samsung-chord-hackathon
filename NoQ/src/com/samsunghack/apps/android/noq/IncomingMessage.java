...
public class IncomingMessage extends Activity {
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(context,
        		com.samsunghack.apps.android.noq.NavDrawerMainActivity.class));

        // "App"
        intents[1] = new Intent(context, com.samsunghack.apps.android.noq.NavDrawerMainActivity.class);
        intents[1].putExtra("com.example.android.apis.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, com.samsunghack.apps.android.noq.NavDrawerMainActivity.class);
